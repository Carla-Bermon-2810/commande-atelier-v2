...
export default function Hero() {
  return (
    <section className="relative min-h-[17rem] overflow-hidden rounded-2xl border border-slate-800 bg-[#10191e] sm:min-h-[20rem] lg:min-h-[16.5rem] lg:rounded-none lg:border-x-0">
      <div
      ...
      <div className="relative z-10 flex min-h-[17rem] max-w-3xl flex-col justify-center px-5 py-7 text-white sm:min-h-[20rem] sm:px-10 sm:py-8 lg:min-h-[16.5rem] lg:px-10 lg:py-6">
