  ...
  return (
    <div className="h-full">
      <Link href={href} className="block h-full">
        <div className="group relative flex h-full min-h-52 flex-col justify-end overflow-hidden rounded-2xl border border-slate-200 bg-[#132128] shadow-[0_5px_15px_rgba(15,23,42,0.1)] transition-all duration-200 hover:-translate-y-1 hover:border-[#356779] hover:shadow-[0_18px_34px_rgba(15,23,42,0.18)] sm:min-h-60">
          ...
          <div className="relative z-10 flex items-end justify-between gap-3 p-4 sm:p-5">
            <div className="min-w-0">
              <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-[#d98257]/20 text-[#f0a47c] backdrop-blur-sm"><Icon size={21} strokeWidth={2} /></div>
            ...
            <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#d98257] text-white shadow-lg transition group-hover:translate-x-1 group-hover:bg-[#bd6b44]"><ArrowRight size={21} /></span>
          </div>
        </div>
      </Link>
    </div>
